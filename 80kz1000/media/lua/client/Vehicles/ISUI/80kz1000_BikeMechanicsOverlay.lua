-- Kawamadafaki
ISCarMechanicsOverlay.CarList["Base.80kz1000"] = {imgPrefix = "80kz1000_", x=10,y=0};
-- Top secret parts
...
ISCarMechanicsOverlay.PartList["SuspensionFrontRight"].vehicles["80kz1000_"] = {img="suspension_front_left", x=0,y=0,x2=0,y2=0};
...
ISCarMechanicsOverlay.PartList["SuspensionRearRight"].vehicles["80kz1000_"] = {x=0,y=0,x2=0,y2=0};
ISCarMechanicsOverlay.PartList["TireFrontRight"].vehicles = ISCarMechanicsOverlay.PartList["TireFrontRight"].vehicles or {};
ISCarMechanicsOverlay.PartList["TireFrontRight"].vehicles["80kz1000_"] = {x=0,y=0,x2=0,y2=0};
ISCarMechanicsOverlay.PartList["TireRearRight"].vehicles = ISCarMechanicsOverlay.PartList["TireRearRight"].vehicles or {};
ISCarMechanicsOverlay.PartList["TireRearRight"].vehicles["80kz1000_"] = {x=0,y=0,x2=0,y2=0};
--
ISCarMechanicsOverlay.PartList["Battery"].vehicles = ISCarMechanicsOverlay.PartList["Battery"].vehicles or {};
ISCarMechanicsOverlay.PartList["Battery"].vehicles["80kz1000_"] = {img="battery", x=14,y=150,x2=60,y2=182};
--
...
ISCarMechanicsOverlay.PartList["SuspensionFrontLeft"].vehicles["80kz1000_"] = {img="suspension_front_left", x=14,y=57,x2=54,y2=94};
ISCarMechanicsOverlay.PartList["SuspensionRearLeft"].vehicles = ISCarMechanicsOverlay.PartList["SuspensionRearLeft"].vehicles or {};
ISCarMechanicsOverlay.PartList["SuspensionRearLeft"].vehicles["80kz1000_"] = {x=14,y=200,x2=54,y2=238};
--
ISCarMechanicsOverlay.PartList["BrakeFrontLeft"].vehicles = ISCarMechanicsOverlay.PartList["BrakeFrontLeft"].vehicles or {};
ISCarMechanicsOverlay.PartList["BrakeFrontLeft"].vehicles["80kz1000_"] = {img="brake_front_left", x=14,y=94,x2=54,y2=132};
ISCarMechanicsOverlay.PartList["BrakeRearLeft"].vehicles = ISCarMechanicsOverlay.PartList["BrakeRearLeft"].vehicles or {};
ISCarMechanicsOverlay.PartList["BrakeRearLeft"].vehicles["80kz1000_"] = {x=14,y=238,x2=54,y2=274};
--
ISCarMechanicsOverlay.PartList["Engine"].vehicles = ISCarMechanicsOverlay.PartList["Engine"].vehicles or {};
ISCarMechanicsOverlay.PartList["Engine"].vehicles["80kz1000_"] = {x=196,y=57,x2=268,y2=100};
--
ISCarMechanicsOverlay.PartList["HeadlightLeft"].vehicles = ISCarMechanicsOverlay.PartList["HeadlightLeft"].vehicles or {};
ISCarMechanicsOverlay.PartList["HeadlightLeft"].vehicles["80kz1000_"] = {x=128,y=114,x2=153,y2=132};
--
ISCarMechanicsOverlay.PartList["Muffler"].vehicles = ISCarMechanicsOverlay.PartList["Muffler"].vehicles or {};
ISCarMechanicsOverlay.PartList["Muffler"].vehicles["80kz1000_"] = {x=232,y=245,x2=268,y2=315};
--
...
ISCarMechanicsOverlay.PartList["ATAMotoTireFrontWheel"].vehicles["80kz1000_"] = {x=132,y=57,x2=149,y2=77};
ISCarMechanicsOverlay.PartList["ATAMotoTireRearWheel"].vehicles["80kz1000_"] = {x=14,y=274,x2=54,y2=313};
--
ISCarMechanicsOverlay.PartList["GasTank"].vehicles = ISCarMechanicsOverlay.PartList["GasTank"].vehicles or {};
ISCarMechanicsOverlay.PartList["GasTank"].vehicles["80kz1000_"] = {img="gastank", x=206,y=192,x2=268,y2=232};
--